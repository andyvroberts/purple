...
class TestUtilsStorageTable(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.price_rec_1 = {'Postcode': 'BR3 4RL', 'Address': '309 - 311 BECKENHAM ROAD', 'Price': 525000, 'Date': '2019-05-29',
                            'Locality': '', 'Town': 'BECKENHAM', 'District': 'BROMLEY', 'County': 'GREATER LONDON', 'RecStatus': 'A'}
        self.converted_1 = {'PartitionKey': 'BR3', 'RowKey': 'BR3 4RL~309 - 311 BECKENHAM ROAD', 'Prices': ['2019-05-29~525000~A'],
                            'Address': '309 - 311 BECKENHAM ROAD', 'Postcode': 'BR3 4RL', 'Locality': '', 'Town': 'BECKENHAM', 'District': 'BROMLEY', 'County': 'GREATER LONDON'}

        self.price_entity_1 = {'PartitionKey': 'BR3', 'RowKey': 'BR3 1HE~1 EMBASSY GARDENS', 'Prices': ['2019-02-20~274500~A'],
                               'Address': '1 EMBASSY GARDENS', 'Postcode': 'BR3 1HE', 'Locality': '', 'Town': 'BECKENHAM', 'District': 'BROMLEY', 'County': 'GREATER LONDON'}
        self.price_entity_2 = {'PartitionKey': 'BR3', 'RowKey': 'BR3 1JW~4 VICARAGE DRIVE', 'Prices': ['2019-09-27~582000~A'],
                               'Address': '4 VICARAGE DRIVE', 'Postcode': 'BR3 1JW', 'Locality': '', 'Town': 'BECKENHAM', 'District': 'BROMLEY', 'County': 'GREATER LONDON'}
        self.price_entity_3 = {'PartitionKey': 'BR3', 'RowKey': 'BR3 3FA~6 CHANCELLORS CLOSE', 'Prices': ['2019-05-24~375000~A', '2016-01-24~365000~A'],
        ...
        self.price_entity_4 = {'PartitionKey': 'BR3', 'RowKey': 'BR3 1HE~1 EMBASSY GARDENS', 'Prices': ['2019-02-20~274500~A'],
                               'Address': '1 EMBASSY GARDENS', 'Postcode': 'BR3 1HE', 'Locality': '', 'Town': 'BECKENHAM', 'District': 'BROMLEY', 'County': 'GREATER LONDON'}
        self.price_entity_5 = {'PartitionKey': 'BR3', 'RowKey': 'BR3 1HE~1 EMBASSY GARDENS', 'Prices': ['2011-01-01~274500~A'],
                               'Address': '1 EMBASSY GARDENS', 'Postcode': 'BR3 1HE', 'Locality': '', 'Town': 'BECKENHAM', 'District': 'BROMLEY', 'County': 'GREATER LONDON'}

    # ------------------------------------------------------------------------------
    def test_convert_landreg_price_to_table_entity(self):
        result = storage_table.create_entity_from_price_record(
            self.price_rec_1)
    ...
    def test_convert_string_to_list(self):
        prices_string = "2019-02-20~274500~A, 2019-02-20~274500~A"
    ...
    def test_convert_list_to_string(self):
        prices_list = ['2019-02-20~274500~A', ' 2019-02-20~274500~A']
    ...
    def test_dedup_rowkey_and_merge_prices_can_group(self):
        bat = [self.price_entity_1, self.price_entity_2,
               self.price_entity_3, self.price_entity_4]
    ...
    def test_merge_2_single_prices_returns_correct_list(self):
        bat = [self.price_entity_1, self.price_entity_2]
        expected_price_list = ['2019-02-20~274500~A', '2019-09-27~582000~A']
    ...
    def test_merge_multiple_prices_returns_correct_list(self):
        ...
        expected_price_list = [
            '2019-02-20~274500~A', '2016-01-24~365000~A', '2019-09-27~582000~A', '2019-05-24~375000~A']
    ...
    def test_merge_multiple_prices_returns_sorted_list(self):
        ...
        expected_price_list = [
            '2016-01-24~365000~A', '2019-02-20~274500~A', '2019-05-24~375000~A', '2019-09-27~582000~A']
    ...
    def test_merge_3_prices_in_same_entity_returns_correct_prices(self):
        ...
        # the final
        expected_price_list = ['2019-02-20~274500~A', '2011-01-01~274500~A']
    ...
    def test_when_price_exists_returns_true(self):
        matching_price = ['2019-02-20~274500~A']

        result = storage_table.price_exists(
            self.price_entity_1, matching_price)
        expected_true = True
    ...
    def test_when_price_does_not_exist_returns_false(self):
        non_matching_price = ['2011-02-20~270000~A']

        result = storage_table.price_exists(
            self.price_entity_1, non_matching_price)
