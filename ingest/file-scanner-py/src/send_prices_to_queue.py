...
log = logging.getLogger("purple.v2.src.local.send_prices_to_queue")
#------------------------------------------------------------------------------
def controller():
    """
        ...
        3. Push each postcode payload to an storage queue for later processing
...
def deactivate_outcodes(cl1, outcode_list):
    """
        Update the ready configuration rows to mark it as done.
